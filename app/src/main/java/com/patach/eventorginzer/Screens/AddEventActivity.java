...
public class AddEventActivity extends AppCompatActivity {
    private EditText et_event,et_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef= FirebaseStorage.getInstance().getReference("event_images");
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validate(event,description))   add();;
            }
        });
    }
...
//
    ...
    private boolean validate(String event, String description) {
        if (event.isEmpty()) et_event.setError("Enter event name!");
        else if (imgUri==null) Toast.makeText(AddEventActivity.this,"select your image",Toast.LENGTH_LONG).show();
        ...
        storageReference.putFile(imgUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        myRef=  FirebaseDatabase.getInstance().getReference("Events").child(id);
                        myRef.child("Name").setValue(et_event.getText().toString());
                        myRef.child("Description").setValue(et_description.getText().toString());
                        myRef.child("EventId").setValue(id);
                        myRef.child("UserName").setValue(getUsername(AddEventActivity.this));
                        myRef.child("UserImage").setValue(getUserPic(AddEventActivity.this));
                        myRef.child("UserId").setValue(getUserId(AddEventActivity.this));
                        myRef.child("Image").setValue(downloadUrl.toString());
                        loadingDialog.dismiss();
                        Toast.makeText(AddEventActivity.this,"Event Added successful",Toast.LENGTH_LONG).show();
                        finish();
                    }
                })
